    ...
    <div class="container mt-50 mb-50">
           ...
           <div class="card-body">
             <div class="d-flex align-items-center">
               <div>
                 ...
                 <h4 class="my-1 text-info">{{$totalCost}} JD</h4>
               </div>
            ...
            <div class="card-body">
              <div class="d-flex align-items-center">
                <div>
                  ...
                  <h4 class="my-1 text-danger">{{$totalPurchase}}</h4>
                </div>
          ...
          <div class="card radius-10 border-start border-0 border-3 border-success">
            <div class="card-body">
              <div class="d-flex align-items-center">
                <div>
                  <p class="mb-0 text-secondary">Total Deliverd</p>
                  <h4 class="my-1 text-success">{{$totalDeliverd}}</h4>
                </div>
                <div class="widgets-icons-2 rounded-circle bg-gradient-ohhappiness text-white ms-auto"><i class="fa fa-gift icon-stat-visual"></i>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card radius-10 border-start border-0 border-3 border-warning">
            <div class="card-body">
              <div class="d-flex align-items-center">
                <div>
                  <p class="mb-0 text-secondary">Total Canceled</p>
                  <h4 class="my-1 text-warning">{{$totalCanceled}}</h4>
                </div>
                    ...
                    <div class="card-body">
                        <table class="table table-striped">
                            ...
                            <tr >
                                ...
                                <td>
                            <a href="{{route('user.order.details',['order_id'=>$order->id])}}" class="btn btn-info btn-sm">Details</a>    
                                </td>
                            </tr>
                            @endforeach
                            </tbody>

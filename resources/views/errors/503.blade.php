...
<div class="page-404">
    <div class="outer">
        <div class="middle">
            <div class="inner">
                <!--BEGIN CONTENT-->
                <div class="inner-circle"><i class="fa fa-cogs"></i><span>503</span></div>
                <span class="inner-status">Opps! Service Unavailable !</span>
                <span class="inner-detail" style="color:#fff;">
                    Unfortunately we're having trouble 
                    Unavailable the page you are looking for. Please come back in a while.
                </span>
                <!--END CONTENT-->
            </div>
        </div>

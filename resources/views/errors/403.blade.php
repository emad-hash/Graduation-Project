...
<div class="page-404">
    <div class="outer">
        <div class="middle">
            <div class="inner">
                <!--BEGIN CONTENT-->
                <div class="inner-circle"><i class="fa fa-home"></i><span>403</span></div>
                <span class="inner-status">Oops! Forbidden</span>
                <span class="inner-detail" style="color:#fff;">
                    The page you are looking for is Forbidden.
                    <a href="{{route('home.index')}}" class="btn btn-info mtl"><i class="fa fa-home"></i>&nbsp;
                        Return home
                    </a> 
                </span>
            </div>
